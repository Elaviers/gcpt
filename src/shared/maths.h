...
namespace Maths
{
	...
	{
		AssertM(size > 0, "Maths::Min called with 0 size");
	...
	{
		AssertM(size > 0, "Maths::Max called with 0 size");
	...
	double Log(double x, float base);

	float Pow(float x, float pwr);
	double Pow(double x, double pwr);
