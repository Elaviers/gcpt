...
public:
	Function(ReturnType(*fptr)(Args...) = nullptr) : _cc(nullptr), _fptr(fptr), _static{}
	{}
	...
	ReturnType operator()(Args... args) const
	{
		...
		if (_fptr) return _fptr(std::forward<Args>(args)...);
		return (ReturnType)0;
	}
...
using CommandPtr = Function<void, const Array<String>&>;
