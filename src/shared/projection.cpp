...
{
	AssertM(_type == EProjectionType::PERSPECTIVE, "SetPerspectiveFOV not called on a perspective projection! That won't do much!");
...
{
	AssertM(_type == EProjectionType::ORTHOGRAPHIC, "SetOrthographicScale not called on an orthographic projection! That won't do much!");
