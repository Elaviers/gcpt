...
protected:
	...
	void _OnFocusLost() { _selectionStart = _selectionEnd = 0; }
...
public:
	...
	UITextbox& SetBorderSize(UIPanel::EBorder borders, float borderSize) { _panel.SetBorderSize(borders, borderSize); return *this; }
